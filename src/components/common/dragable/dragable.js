...
const Dragable = ({ details, setDetails }) => {
    ...
    const handleDrop = (e, index) => {
        ...
        let temp = newDetails[newIndex];
        newDetails[newIndex] = newDetails[index];
        newDetails[index] = temp;
                ...
                return (
                    ...
                    >
                        <div className="flex gap-4">
                            <div 
                                className="drag-action-move cursor-move h-4 w-4 flex items-center justify-center"
                                draggable
                        ...
                        <div className={`pt-1 ${index == editIndex ? 'block': 'hidden'}`}>
                            <textarea 
